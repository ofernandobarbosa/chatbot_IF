...
class contato_dos_professoresSerializer(serializers.ModelSerializer):
    class Meta:
        model = Evento
        fields = ['categoria','usuario','data_atualizacao', 'visivel', 'nome_do_professor', 'sobrenome_do_professor','email','nome_da_disciplina']
...
class informacoes_sobre_inscricao_ou_matriculaSerializer(serializers.ModelSerializer):
    class Meta:
        model = Evento
        fields = ['categoria','usuario','data_atualizacao', 'visivel', 'modalidade_de_ingresso', 'nome_evento','descricao','link_1','link_2','link_3','arquivo_1','arquivo_2','arquivo_3']
