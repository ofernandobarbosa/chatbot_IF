...
class informacoes_relevantes_dos_cursosSerializer(serializers.ModelSerializer):
    class Meta:
        model = Evento
        fields = ['categoria', 'usuario', 'data_atualizacao', 'visivel', 'modalidade_do_curso', 'nome_do_curso', 'descricao',
...
class informacoes_sobre_inscricao_ou_matriculaSerializer(serializers.ModelSerializer):
    class Meta:
        model = Evento
        fields = ['categoria', 'usuario', 'data_atualizacao', 'visivel', 'nome_evento',
                  'descricao', 'link_1', 'link_2', 'link_3', 'arquivo_1', 'arquivo_2', 'arquivo_3']


class informacoes_sobre_rematriculaSerializer(serializers.ModelSerializer):
    class Meta:
        model = Evento
        fields = ['categoria', 'usuario', 'data_atualizacao', 'visivel', 'modalidade_do_curso',
...
class requerimentos_ou_formulariosSerializer(serializers.ModelSerializer):
    class Meta:
        model = Evento
        fields = ['categoria', 'usuario', 'data_atualizacao', 'visivel', 'nome_do_requerimento', 'descricao',
                  'data_de_inicio', 'data_de_fim', 'link_1', 'link_2', 'arquivo_1', 'arquivo_2', 'foto_1', 'foto_2']
...
class tutoriais_de_acessos_a_sistemas_academicosSerializer(serializers.ModelSerializer):
    class Meta:
        model = Evento
        fields = ['categoria', 'usuario', 'data_atualizacao', 'visivel',
                  'nome_do_sistema', 'descricao', 'link_1', 'link_2', 'arquivo_1', 'arquivo_2']
